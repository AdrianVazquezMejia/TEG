...
El presente trabajo está estructurado de la forma descrita a continuación. En el capítulo I se expone el problema se da la justificación y alcance del trabajo. Los objetivos también se presentan en este capítulo. Más adelante en el capítulo II se desarrollan las bases teóricas de sirven como apoyo para explicar los conceptos de las redes WiFi malladas, el protocolo Modbus y el microcontrolador ESP32.
