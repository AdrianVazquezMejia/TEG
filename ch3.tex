...
En las tramas \espn los bits de control de tramas \textit{FromDS} y \textit{ToDS} son ambos cero.
El tercer campo de direcciones configura la dirección broadcast como (0xFF:0xFF:0xFF:0xFF:0xFF:0xFF).
...
La nodos deben soportar al menos la configuración básica descrita por Modbus para linea serial, que indica: 
\begin{itemize}
\item Dirección configurable desde 1 a 247.
\item funcionalidad de broadcast.
\item Tasa de baudios.
\item Paridad par.
\item Interfaz eléctrica RS-485 (dos cables) o RS-232. 
\item Modo RTU.
\end{itemize}
 
 También debe cumplir con otras especificaciones que Modbus \emph{Modbus organization} dicte para garantizar la interoperatividad con otros equipos Modbus.
