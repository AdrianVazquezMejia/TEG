...
\begin{figure}[H]
\centering
\includegraphics[scale=0.5]{dcdc.jpg}\label{dcdcF}
...
Se toma la topología \ref{topo} como base para todas las pruebas, excepto, por supuesto, la prueba de topología.  Se colocó el nodo 150 como el nodo que posee el maestro conectado,  el nodo 151 para ejecutar  reenvío de datos y los nodod 153 y 152 con  un esclavo Modbus conectados.
