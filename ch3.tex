...
\subsubsection{Ilustración de los nodos}
 ...
 \caption{Hardware del nodo maestro (Foto  no definitiva).}\label{master Node}
 \end{figure}
 
\begin{figure}[H]
\centering
\includegraphics[scale=0.2]{images/foto2.jpeg}
\caption{Hardware de un nodo con un esclavo Modbus (Foto no definitiva)}\label{Slave Node}
\end{figure}
