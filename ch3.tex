...
\item Valores aleatorios: son usados para prevenir ataques de retransmisión.
...
\item Longitud: Es la longitud total de ID de organización, tipo, versión  y cuerpo.
\item Tipo: Es establecido en 4, para indicar \espn.
\item Versión: Versión de \espn.
\item Cuerpo: El  cuerpo contiene los datos \espn.
\end{enumerate}
