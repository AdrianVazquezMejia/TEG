...
\subsubsection{Librerías}
 ...
 La libreria nvs\_flash.h, habilita para el uso de la funciones de acceso a la flash, necesarias para guardar y cargar la configuración a los nodos.
...
El ESP-IDF provee un manejador de eventos para el UART, así como estruturas de datos diseñadas para su configuración. Por lo tanto, se configuró el UART1 para la comunicación RS-485 \emph{half-duplex}. El UART0 esta reservado para la quema del microcontrolador y logs de información y error.
...
Las características de los elementos equipos Mosbus usados fueron los descritos en la tabla %\ref{Dispositivos Modbus}.%foto nodo
