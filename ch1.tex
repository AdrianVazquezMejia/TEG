...
\subsection{La capa de transporte}
 La función básica de la capa de transporte es aceptar datos de una capa más alta, descomponerla en unidades más pequeñas, si es  necesario y asegurarse que estas piezas llegar correctamente al destino. Para propósitos de eficiencia, se puede multiplexar varias conexiones de transporte.
