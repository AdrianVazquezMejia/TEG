...
\caption{Topología usada por Lech y Wlodarski \cite{IoTWMN}}\label{Fig3: Esquema WMN 1}
\end{figure}
...
\caption{Topología usada por Yujun Cheng, Dong Yang y Huachun Zhou \cite{article3}}\label{Fig4: Esquema WMN 2}
\end{figure}
...
\caption{Topología de árbol de ESP-IDF \cite{MESHIDF}}\label{Fig5: Topologia ESP-MESH}
\end{figure}
...
\caption{Diagrama funcional del ESP-32\cite{esp32}}
\end{figure}
